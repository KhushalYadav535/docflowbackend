...
CREATE INDEX idx_versions_checksum ON document_versions(checksum);
...
CREATE INDEX idx_metadata_fields_tenant ON metadata_fields(tenant_id);
...
CREATE INDEX idx_metadata_values_document ON metadata_values(document_id);
CREATE INDEX idx_metadata_values_field ON metadata_values(field_id);
...
CREATE INDEX idx_search_index_text ON search_index USING gin(to_tsvector('english', extracted_text));
...
CREATE INDEX idx_categories_tenant ON document_categories(tenant_id);
